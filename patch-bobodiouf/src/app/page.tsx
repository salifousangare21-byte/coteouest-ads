...
const stats = [
  { value: "1,7 M", label: "Abonnés cumulés, deux chaînes" },
  { value: "61,2 M", label: "Vues en Afrique depuis janvier 2026" },
  { value: "592,8 M", label: "Impressions générées" },
  { value: "333 K", label: "Vues générées par jour" },
];
  ...
  return (
    <div className="flex flex-col flex-1">
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 md:px-16 py-4 bg-white/95 backdrop-blur-md border-b border-black/[.08]">
        <span className="serif text-xl">Côte Ouest <em className="italic" style={{ color: "var(--gold)" }}>Digital</em></span>
      ...
      <section className="flex-1 flex items-center bg-black text-white px-8 md:px-16 pt-32 pb-20">
        <div className="max-w-3xl">
          <div className="eyebrow mb-6">Novelas Avenue × Les Bobodiouf</div>
      ...
      <section className="px-8 md:px-16 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {channels.map((c) => (
              <div key={c.name} className="border border-black/10">
                ...
                <div className="grid grid-cols-3 gap-px bg-black/5">
                  {c.posters.map((p) => (
                    <div key={p} className="relative aspect-[2/3] bg-black/5">
